...
const RestaurantList = ({ nearbyPlaces, isLoaded, type, navigation, setMapRadius, setRating, rating }) => {

  return (
    < View flex={1} p={'10px'} >
      <FilterButtonsList
        totalMatchedRestaurants={nearbyPlaces.length} isLoaded={isLoaded} setMapRadius={setMapRadius} setRating={setRating} rating={rating} />
